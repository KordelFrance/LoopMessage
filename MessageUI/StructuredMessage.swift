...
class StructuredMessage: NSObject, JSQMessageMediaData {
    ...
    func createView() -> UIView {
        ...
        //        overlayImageView.image = UIImage(named: "Product")
        ...
        productView.topAnchor.constraintEqualToAnchor(messageView.topAnchor, constant: 5).active = true
        productView.bottomAnchor.constraintEqualToAnchor(messageView.bottomAnchor, constant: -5).active = true
        productView.widthAnchor.constraintEqualToAnchor(messageView.widthAnchor, constant: -0.8*UIScreen.mainScreen().bounds.size.width).active = true
        //        productView.leftAnchor.constraintEqualToAnchor(messageView.leftAnchor, constant: -0.06*UIScreen.mainScreen().bounds.size.width).active = true
        //        productView.heightAnchor.constraintEqualToAnchor(messageView.heightAnchor, constant: -10).active = true
        productView.rightAnchor.constraintEqualToAnchor(messageView.rightAnchor, constant: -0.85*UIScreen.mainScreen().bounds.size.width).active = true
        //        productView.rightAnchor.constraintEqualToAnchor(overlayImageView.rightAnchor, constant: -0.9*UIScreen.mainScreen().bounds.size.width).active = true
        ...
        button.titleLabel!.font =  UIFont(name: "HelveticaNeue", size: 0.02*UIScreen.mainScreen().bounds.size.height)
        button.translatesAutoresizingMaskIntoConstraints = false
        messageView.addSubview(button)
        button.bottomAnchor.constraintEqualToAnchor(messageView.bottomAnchor, constant: -5).active = true
        button.leftAnchor.constraintEqualToAnchor(messageView.leftAnchor, constant: 0.2*UIScreen.mainScreen().bounds.size.width).active = true
        button.topAnchor.constraintEqualToAnchor(messageView.topAnchor, constant: 0.125*UIScreen.mainScreen().bounds.size.height).active = true
        button.widthAnchor.constraintEqualToAnchor(messageView.widthAnchor, constant: -0.8*UIScreen.mainScreen().bounds.size.width).active = true
...
//        productLabel.text = "Men's Nike Roshe One NM Flyknit"
        ...
        productLabel.font = UIFont(name: "HelveticaNeue", size: 0.025*UIScreen.mainScreen().bounds.size.height)
        productLabel.lineBreakMode = .ByWordWrapping
        productLabel.numberOfLines = 0
        productLabel.translatesAutoresizingMaskIntoConstraints = false
        messageView.addSubview(productLabel)
        productLabel.topAnchor.constraintEqualToAnchor(messageView.topAnchor, constant: -10).active = true
        productLabel.leftAnchor.constraintEqualToAnchor(messageView.leftAnchor, constant: 0.2*UIScreen.mainScreen().bounds.size.width).active = true
        productLabel.rightAnchor.constraintEqualToAnchor(messageView.rightAnchor, constant: -0.15*UIScreen.mainScreen().bounds.size.width).active = true
//        productLabel.widthAnchor.constraintEqualToAnchor(messageView.widthAnchor, constant: -0.4*UIScreen.mainScreen().bounds.size.width).active = true
        productLabel.bottomAnchor.constraintEqualToAnchor(messageView.bottomAnchor, constant: -0.15*UIScreen.mainScreen().bounds.size.width).active = true
...
//        productDetailLabel.text = "Black/White/Cool Grey/Dark Grey"
        ...
        //        productDetailLabel.leftAnchor.constraintEqualToAnchor(messageView.leftAnchor, constant: 0.3*UIScreen.mainScreen().bounds.size.width).active = true
        ...
        productDetailLabel.topAnchor.constraintEqualToAnchor(productLabel.bottomAnchor, constant: 0.0075*UIScreen.mainScreen().bounds.size.height).active = true
        productDetailLabel.bottomAnchor.constraintEqualToAnchor(productLabel.bottomAnchor, constant: 0.05*UIScreen.mainScreen().bounds.size.height).active = true
        //        productDetailLabel.topAnchor.constraintEqualToAnchor(messageView.topAnchor, constant: 0.3*UIScreen.mainScreen().bounds.size.height).active = true
        //        productDetailLabel.rightAnchor.constraintEqualToAnchor(messageView.rightAnchor, constant: -5).active = true
        //        productDetailLabel.bottomAnchor.constraintEqualToAnchor(messageView.bottomAnchor, constant: -0.3*UIScreen.mainScreen().bounds.size.height).active = true
